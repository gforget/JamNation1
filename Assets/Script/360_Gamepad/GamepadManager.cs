...
public class GamepadManager : MonoBehaviour
{
    ...
    public bool GetAnyStickTapUp_L()
    {
        for (int i = 0; i < gamepads.Count; ++i)
        {
            // Gamepad meets both conditions
            if (gamepads[i].IsConnected && gamepads[i].GetStickTapUp_L())
                return true;
        }
    ...
    public bool GetAnyStickTapDown_L()
    {
        for (int i = 0; i < gamepads.Count; ++i)
        {
            // Gamepad meets both conditions
            if (gamepads[i].IsConnected && gamepads[i].GetStickTapDown_L())
                return true;
        }
    ...
    public bool GetAnyStickTapUp_R()
    {
        for (int i = 0; i < gamepads.Count; ++i)
        {
            // Gamepad meets both conditions
            if (gamepads[i].IsConnected && gamepads[i].GetStickTapUp_R())
                return true;
        }
    ...
    public bool GetStickTapDown_R()
    {
        ...
        {
            // Gamepad meets both conditions
            if (gamepads[i].IsConnected && gamepads[i].GetStickTapDown_R())
                return true;
        }
